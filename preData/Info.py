...
wPath='/media/a00001/E/age/IMDB/imdb_crop/'
...
for i in range(len(dob)):
    if(os.path.exists(wPath+str(full_path[i][0].encode("utf-8")))):
        ...
        info.write(' ' + str(face_score[i]))
        info.write(' ' + str(second_face_score[i]))
